...
public class SequencerGameActivity extends AppCompatActivity implements Observer {
    ...
    public void update() {
        ...
        if (controller.boardManager.sequence.position == controller.boardManager.getRound()) {
            controller.boardManager.increaseRound();
    ...
    private void Speak() {
        int round = controller.boardManager.getRound();

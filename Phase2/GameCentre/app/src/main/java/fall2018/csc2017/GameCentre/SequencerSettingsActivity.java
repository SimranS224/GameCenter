 ...
 */
public class SequencerSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sequencer_settings);
    ...
    /**
     * Activate the SequencerBoard Size Options Button
     */
    ...
    private void createNewGame() {
        ...
        switch (requestedBoardSize) {
            case "3x3":
                SequencerBoard.setBoardSize(3);
                break;
            case "4x4":
                SequencerBoard.setBoardSize(4);
                break;
            case "5x5":
                SequencerBoard.setBoardSize(5);

                break;
        }

        // Sets the correct type of board
        SequencerBoard.setType(requestedType);

        // Sets the correct image
        SequencerBoard.setIMAGE(requestedImage);
    ...
    private void startNewGame() {
        ...
        Intent tmp = new Intent(SequencerSettingsActivity.this, SequencerGameActivity.class);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount() >0) {
                    ...
                    if(map.get("SequencerBoard Size") !=null) {
                        requestedBoardSize = map.get("SequencerBoard Size").toString();
    ...
    private void saveUserInformationOnDatabase() {
        ...
        userInfo.put("SequencerBoard Size", requestedBoardSize);
